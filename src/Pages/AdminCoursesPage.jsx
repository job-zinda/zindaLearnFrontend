...
function CourseDarkModal({ open, title, width = "680px", onClose, children }) {
  if (!open) return null;

  return createPortal(
    <div className="course-dark-modal-overlay" onMouseDown={onClose}>
      <div
        className="course-dark-modal"
        style={{ width }}
        onMouseDown={(e) => e.stopPropagation()}
      >
        <div className="course-dark-modal-header">
          <h2>{title}</h2>

          <button
            type="button"
            className="course-dark-modal-close"
            onClick={onClose}
        ...
        <div className="course-dark-modal-body">{children}</div>
      </div>
    </div>,
    document.body
  );
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (categoryKey === "online_tuition") {
        formData.append(
          "sectionType",
          selectedCourse.sectionType || form.sectionType
        );
      }
  ...
  return (
    <div className="admin-courses-page">
      ...
      {categoryKey === "online_tuition" ? (
        <>
          <div className="courses-tabs">
            ...
            >
              <span className="courses-tab__title">One-to-One Session</span>
              <span className="courses-tab__subtitle">
            ...
            >
              <span className="courses-tab__title">Group / Batch Session</span>
              <span className="courses-tab__subtitle">
                Learn together with peers in structured batch environments
      ...
      <CourseDarkModal
        ...
        width="680px"
      >
        <form className="course-dark-form" onSubmit={handleCreate}>
          <label className="course-dark-field">
            <span>{nameLabel}</span>
            <input
              type="text"
              value={form.name}
          ...
          <div className="course-dark-actions">
            <button
              type="button"
              className="course-dark-secondary-btn"
            ...
            <button
              type="submit"
              className="course-dark-primary-btn"
              disabled={submitting}
            >
              {submitting
                ? "Adding..."
      ...
      <CourseDarkModal
        ...
        width="680px"
      >
        <form className="course-dark-form" onSubmit={handleUpdate}>
          {selectedCourse?.image ? (
            <div className="course-dark-preview">
              <img
                src={getMediaUrl(selectedCourse.image)}
                alt={selectedCourse.name}
              />
      ...
      <CourseDarkModal
        ...
        width="520px"
      >
        <div className="course-dark-delete-box">
          <p>
            Are you sure you want to delete{" "}
            <strong>{selectedCourse?.name || "this course"}</strong>?
          </p>
          ...
          <div className="course-dark-actions">
            ...
            <button
              type="button"
              className="course-dark-danger-btn"
              onClick={confirmDeleteCourse}
              disabled={submitting}
            >
              {submitting ? "Deleting..." : "Delete"}
