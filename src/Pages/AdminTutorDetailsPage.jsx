  ...
  return createPortal(
    <div className="tutor-detail-dark-modal-overlay" onMouseDown={onClose}>
      ...
      >
        ...
        <div className="tutor-detail-dark-modal-body">
          {children}
        </div>
      </div>
    </div>,
...
async function updateTutor(e) {
  ...
  try {
    ...
    showAlert(getErrorMessage(err, "Failed to update tutor"), "error");
  } finally {
    setSubmitting(false);
  }
}
...
async function toggleTutorBlock() {
  ...
  if (loading) {
    return (
  <div className="tutor-detail-page" onClick={() => setDetailMenuOpen(false)}>
