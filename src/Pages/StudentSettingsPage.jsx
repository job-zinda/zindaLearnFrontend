...
const content = {
  ...
  terms: {
    ...
    body: [
      ...
      "http://localhost:5173/ is an online school platform designed to help students learn from home by connecting them with tutors, online classes, study support, and learning resources. The platform provides digital learning services for school students across different subjects and levels.",

      "General",

      "http://localhost:5173/, hereinafter referred to as the Website, is owned and operated by Zinda Learn, an online education service provider. By accessing or using the Website, you agree that you have read, understood, and accepted these Terms and Conditions, along with the Privacy Policy and other policies of the platform.",
